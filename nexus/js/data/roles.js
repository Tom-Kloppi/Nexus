...
Nexus.ROLES = {
    ...
    subGoals: [
      {
        ...
        steps: [
          ...
          { stage: 3, metricValue: 7, cumulativePercent: 25 },
          { stage: 4, metricValue: 11, cumulativePercent: 40 },
    ...
    subGoals: [
      ...
      },
      {
        ...
        steps: [
          ...
          { stage: 2, metricValue: 45, cumulativePercent: 9 },
          { stage: 3, metricValue: 65, cumulativePercent: 16 },
          { stage: 4, metricValue: 85, cumulativePercent: 25 },
  ...
  investor: {
    id: "investor",
    name: "Wirtschaftsversprechen",
    alignment: "Wirtschaft",
    subGoals: [
      {
        id: "money_throughput",
        label: "Kumulierte Geldproduktion",
        maxContribution: 55,
        higherIsBetter: true,
        metricKey: "moneyThroughput",
        steps: [
          { stage: 1, metricValue: 8, cumulativePercent: 6 },
          { stage: 2, metricValue: 18, cumulativePercent: 16 },
          { stage: 3, metricValue: 32, cumulativePercent: 31 },
          { stage: 4, metricValue: 50, cumulativePercent: 49 },
          { stage: 5, metricValue: 70, cumulativePercent: 55 }
        ]
      },
      {
        id: "trade_volume",
